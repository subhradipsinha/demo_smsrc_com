...
public class ConfigarationManager {
    ...
    public static void conficfile() throws Exception {
        ...
        //Read confic file
        File con = new File("D:\\demo_smrc_com\\src\\main\\resources\\Config.properties");
        ...
        //Read OR file
        File con1 = new File("D:\\demo_smrc_com\\src\\main\\resources\\OR.properties");
        ...
        //Read TestData file
        File con2 = new File("D:\\demo_smrc_com\\src\\main\\resources\\TestData.properties");
